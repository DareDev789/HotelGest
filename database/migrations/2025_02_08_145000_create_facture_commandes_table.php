...
return new class extends Migration {
    ...
    {
        Schema::create('societe_factures_commandes', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('id_accompte')->references('id')->on('societe_accomptes_commandes')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('societe_factures_commandes');
    }
};
